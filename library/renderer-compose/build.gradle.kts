...
kotlin {
    android {
        namespace = "io.github.numq.blueprint.compose.renderer.compose"
...
mavenPublishing {
    ...
    coordinates(
        groupId = "io.github.numq.blueprint", artifactId = "renderer-compose", version = project.version.toString()
    )

    pom {
        name.set("Blueprint Renderer Compose")
